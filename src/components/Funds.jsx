...
const Funds = ({ userName }) => {
    ...
    const fetchFunds = async () => {
      try {
        const res = await axios.get(
          "https://tradzen-backend.onrender.com/api/funds/my-funds",
          {
  ...
  const handleAddFunds = async () => {
    ...
    try {
      const { data: keyData } = await axios.get(
        "https://tradzen-backend.onrender.com/api/payments/get-razorpay-key",
        {
          withCredentials: true, // important for sending cookies
        }
      );
      ...
      const { data } = await axios.post(
        "https://tradzen-backend.onrender.com/api/payments/create-order",
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          try {
            await axios.post(
              "https://tradzen-backend.onrender.com/api/payments/update-funds",
  ...
  const handleWithdrawFunds = async () => {
    ...
    try {
      await axios.post(
        "https://tradzen-backend.onrender.com/api/funds/withdraw",
        { amount: Number(amount) },
        { withCredentials: true }
      );
